...
for (var i = 0; i < 7; i++){
    ...
    tarefaAberta.innerHTML = 'Dar <span class="remedio">Xarelto</span> | <span class="paciente">Sueli</span><span><a class="retrair" ><img class="expandido" src="imagens/expandido.png" alt=""></a></span><br><a href="" class="feito">Marcar como feito</a><a href="" class="opcoes">...</a>';
