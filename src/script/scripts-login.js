    ...
    let userValid = {
     ...
     listaUser.forEach((item) => {
        ...
        if(email2.value == userValid.email && password.value == userValid.senha){
            ...
            if(userValid.user == 'comum'){
                window.location.href='https://icei-puc-minas-pmv-si.github.io/pmv-si-2021-2-e1-proj-web-t4-g1-gestao-medicamentos/src/home-usuario-comum.html'
            } 
